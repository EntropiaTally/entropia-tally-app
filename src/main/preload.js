...
const actions = new Set(['new-session', 'new-instance', 'load-instance', 'overlay-window-toggle', 'logging-status-toggle', 'goto-wiki-weapontool', 'goto-css-guide', 'change-hunting-set']);
